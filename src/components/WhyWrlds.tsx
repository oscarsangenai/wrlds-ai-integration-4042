...
const WhyWrlds = () => {
  ...
  const { ref: benefitsRef, isInView: benefitsInView } = useInView<HTMLDivElement>({ threshold: 0.2 });
  
  return <section id="why-wrlds" className="relative py-16 md:py-24 bg-white overflow-hidden">
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={headerRef} className={`text-center mb-12 md:mb-16 ${headerInView ? 'animate-slide-up' : ''}`}>
        ...
        <div ref={statsRef} className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16 ${statsInView ? 'animate-in' : ''}`}>
          <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all animate-slide-up stagger-1">
          ...
          <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all animate-slide-up stagger-2">
            <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center mx-auto mb-4">
          ...
          <div className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all animate-slide-up stagger-3">
            <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center mx-auto mb-4">
        ...
        <div ref={benefitsRef} className="mb-12">
          <div className={`text-center mb-8 ${benefitsInView ? 'animate-slide-up' : ''}`}>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 ${benefitsInView ? 'animate-in' : ''}`}>
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all animate-slide-up stagger-1">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all animate-slide-up stagger-2">
              <div className="flex items-start">
                <div className="bg-gray-200 rounded-full p-3 mr-4">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-all animate-slide-up stagger-3">
              <div className="flex items-start">
                <div className="bg-gray-200 rounded-full p-3 mr-4">
