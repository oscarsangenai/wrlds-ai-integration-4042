...
const Footer = () => {
  ...
  return (
    <footer id="footer" className="relative isolate bg-[hsl(var(--footer))] text-[hsl(var(--footer-foreground))] pt-16 pb-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/bylaws" className="text-gray-300 hover:text-white transition-colors">ByLaws</Link></li>
            </ul>
          </div>
