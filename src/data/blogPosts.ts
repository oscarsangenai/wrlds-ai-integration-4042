...
export const blogPosts: BlogPost[] = [
  {
    ...
    category: 'Business',
    imageUrl: `${import.meta.env.BASE_URL || '/'}lovable-uploads/078a129e-0f98-4d91-af61-873687db1a04.png`,
    keywords: [
  ...
  },
  {
    ...
    author: 'WRLDS Technologies',
    category: 'Innovation',
    imageUrl: `${import.meta.env.BASE_URL || '/'}lovable-uploads/927dae7e-6aaf-4b76-add2-1287a1dd9dc0.png`,
    keywords: [
      'smart PPE',
      'safety technology',
  ...
  },
  {
    ...
    author: 'WRLDS Technologies',
    category: 'Process',
    imageUrl: `${import.meta.env.BASE_URL || '/'}lovable-uploads/5262afdb-dd24-4d5e-be66-7c6717adbca9.png`,
    keywords: [
      'product development',
  ...
  },
  {
    ...
    author: 'WRLDS Technologies',
    category: 'Innovation',
    imageUrl: `${import.meta.env.BASE_URL || '/'}lovable-uploads/4187f423-ba69-4043-be76-c43098488348.png`,
    keywords: [
      'AI uniforms',
      'emergency response',
      'worker safety',
  ...
  },
  {
    ...
    author: 'WRLDS Technologies',
    category: 'Technology',
    imageUrl: `${import.meta.env.BASE_URL || '/'}lovable-uploads/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png`,
    keywords: [
      'smart textiles',
      'sensor integration',
      'smart manufacturing',
